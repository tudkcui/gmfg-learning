...
def plot():
    ...
    for plot_mu in [False, True]:
        for graphon in ['rank-att']:
            for num_alphas in [10, 20, 30]:
                plt.subplot(2, 3, i)
                if i <= 3:
    ...
    plt.savefig('./figures/SIS_Ablation_M_rank_att.pdf', bbox_inches='tight', transparent=True, pad_inches=0)
    plt.savefig('./figures/SIS_Ablation_M_rank_att.png', bbox_inches='tight', transparent=True, pad_inches=0)
    plt.show()
